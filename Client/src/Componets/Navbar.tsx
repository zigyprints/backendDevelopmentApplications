...
export default function Navbar() {
    ...
    return (
        <motion.div
            ...
            viewport={{ once: true }}
        >
            <nav className={cn('flex justify-between z-50 bg-opacity-60 dark:bg-opacity-30 backdrop-filter dark:backdrop-filter backdrop-blur-lg dark:backdrop-blur-lg bg-slate-300 dark:bg-slate-950')}>
                <Link to={'/'} className='flex xl:w-[25vw] my-2'>
                    <motion.div className='my-1 ml-4 w-12 h-12 rounded-full text-black dark:text-white overflow-hidden transform'>
